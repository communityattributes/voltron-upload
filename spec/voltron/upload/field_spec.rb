...
describe Voltron::Upload::Field do
  ...
  it "can generate file upload input markup" do
    expect(builder.file_field(:avatar)).to eq("<input data-name=\"avatar\" data-files=\"[]\" data-commit=\"[]\" data-upload=\"/users/upload\" type=\"file\" name=\"user[avatar]\" id=\"user_avatar\" />")
  end
